...
sections = { 
    # this will eventually be auto-generated from the file itself
    # but it's manual for now
    'contents': (0, 2),
    'changelog': (2, 5),
    'abbreviations': (5, 7),
    'rules': (7, 133)
...
# todo get_pdf() that returns pdf object

def parse(file_path):
    with open(file_path, 'rb') as f: # Load PDF
        pdf = pdftotext.PDF(f)
